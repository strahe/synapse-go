...
func TestLocalTSSDKBaseline(t *testing.T) {
	...
	if sdkPackage.Version != "2.0.0" {
		t.Fatalf("synapse-sdk package version = %q, want 2.0.0", sdkPackage.Version)
	}
	...
	if corePackage.Version != "0.9.0" {
		t.Fatalf("synapse-core package version = %q, want 0.9.0", corePackage.Version)
	}

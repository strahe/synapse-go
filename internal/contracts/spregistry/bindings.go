...
func (_SPRegistry *SPRegistryTransactor) AnnounceUpgradePlan(opts *bind.TransactOpts, nextImplementation common.Address, delayEpochs *big.Int) (*types.Transaction, error) {
	return _SPRegistry.contract.Transact(opts, "announceUpgradePlan", nextImplementation, delayEpochs)
}

// AnnounceUpgradePlan is a paid mutator transaction binding the contract method 0x7df6b5c3.
//
// Solidity: function announceUpgradePlan(address nextImplementation, uint96 delayEpochs) returns()
func (_SPRegistry *SPRegistrySession) AnnounceUpgradePlan(nextImplementation common.Address, delayEpochs *big.Int) (*types.Transaction, error) {
	return _SPRegistry.Contract.AnnounceUpgradePlan(&_SPRegistry.TransactOpts, nextImplementation, delayEpochs)
}

// AnnounceUpgradePlan is a paid mutator transaction binding the contract method 0x7df6b5c3.
//
// Solidity: function announceUpgradePlan(address nextImplementation, uint96 delayEpochs) returns()
func (_SPRegistry *SPRegistryTransactorSession) AnnounceUpgradePlan(nextImplementation common.Address, delayEpochs *big.Int) (*types.Transaction, error) {
	return _SPRegistry.Contract.AnnounceUpgradePlan(&_SPRegistry.TransactOpts, nextImplementation, delayEpochs)
}

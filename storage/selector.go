...
type ResolvedUploadContext struct {
	Provider        Provider
	DataSetID       *big.Int          // nil when a new data set will be created
	ClientDataSetID *big.Int          // stable caller-chosen ID reused across commits; nil for new datasets (auto-generated by PresignForCommit)
